        ...
        <form id="edit_service_station_form">
            ...
            <div class="form-group col-4">
                ...
                <select class="form-control"  name="ward_number" id="ward_number" >
                    ...
                    foreach($ward as $row){
                        ?>
                    <option <?php if($sarvice_data['ward_number'] == $row['ward_number']){ echo "selected='selected'";}?>value= <?php echo $row['ward_number']; ?>><?php echo $row['ward_number']; ?></option> 
                <?php }?>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#add_service_station_form').on('submit', function(event){
          ...
          var img = $('#profile').val();
          if(img == ''){
            swal('please select img to upload');
            return false;
          }
        $.ajax({
