                        ...
                        <form id="add_ward_form">
                            <div class="form-group col-12">
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" id="ward_number" name="ward_number" placeholder="Enter Ward Number..." maxlength="10" class="form-control" required />
                                </div>
                                ...
                                <div class="form-group col-4">
                                    <label for="jo_contact" class="form-control-label">Jo Contact</label>
                                    <input type="number" id="jo_contact" name="jo_contact" placeholder="EnterJO Number..." maxlength="10" class="form-control" required />
                                </div>

                                <div class="form-group col-4">
                                    <label for="councilor_name" class="form-control-label">Councilor Name</label>
                                    <input type="text" id="councilor_name" name="councilor_name" placeholder="Enter Ward Title..." class="form-control" required />
                                </div>

                                <div class="form-group col-4">
                                    <label for="councilor_contact" class="form-control-label">Councilor Contact</label>
                                    <input type="number" id="councilor_contact" name="councilor_contact" placeholder="Enter Councilor Name..." class="form-control" required />
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach($ward_detail as $row){
                                           echo ' <tr>
                                                ...
                                                <td>'.$row['jo_name'].'</td>
                                                <td>'.$row['jo_contact'].'</td>
                                                <td>'.$row['councilor_name'].'</td>
                                                <td>'.$row['councilor_contact'].'</td>
