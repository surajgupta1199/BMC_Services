...
<body>
    ...
    <div class="card" id="reload">
        ...
        <h1 style = "color: red;text-align: center;" id='heading'><?php echo $sarvice_data['service_head']?></h1>
        <h1 style= "    color: blue;font-size: 20px;text-align: center;" id='head'><?php echo $sarvice_data['service_head']." ".$sarvice_data['nearby_location']." ".$sarvice_data['city']." ".$sarvice_data['state'] ?></h1>
        </br>
            <h>Description</h>
