                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                <div id="containers" class="left" style='margin-top: 26px;'>
...
<script>
  ...
  Array.prototype.forEach.call(allData, function(data){
    var type = data.type_1;
    if(!type){
        data_type = '';
    }else{
        data_type = data.type_1;
    }
    ...
    strong.onclick = function(){
                        $.ajax({
                          url:"<?php echo base_url(); ?>/user_login/show_data/"+data.id,
                          type: "POST",
                          processData:false,
    ...
    console.log(data);
    // var str = data.store_ref_address+"<br/>"+data_type;
    var str = '<p style="font-size:15px;color:black;width: 420px;">'+data.store_ref_address+"<br/>"+'<span style="color:blue">'+data_type+'</span>'+'</p>';
  ...
  function mycategories(id,ids){
    ...
    $.ajax({
      url:"<?php echo base_url(); ?>/user_login/show_particular_categories",
      type: "POST",
  ...
  function show_categories(id,detail){
    $.ajax({
      url:"<?php echo base_url(); ?>/user_login/show_child_categories",
      type: "POST",
      data : {id:id,'detail':detail},
      success: function (result) {
        console.log(result);
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>/user_login/show_child_map",
            type: "POST",
            data : {id:id,'detail':detail},
            success: function (result) {
                console.log(result);
