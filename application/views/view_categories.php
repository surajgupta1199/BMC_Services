...
<html xmlns="http://www.w3.org/1999/xhtml" lang="mr">
    <head>
       ...
       <!--  <img src="<?php echo base_url('assets1/exit.jpg');?>" alt="Trulli" width="400" height="333" center="center"  border-radius= "50px"> -->
        ...
        <div class="wrapper">
            <!--<![endif]-->
            <header id="masthead" style="background-color: green;">
                ...
                <div class="masthead-container" id='header' role="banner">
                    <div class="logo-cont">
                ...
                <nav role="navigation" aria-label="Main Menu">
                    <div id="navigation">
                        <ul id="navigation-top" class="sm sm-blue" data-smartmenus-id="16077523342009307">
                            ...
                            <div class='col-md-6'>
                                <h style="font-size: 28px;font-weight: bold;color: #b5b4ac;">P/North</h>
                            </div>
                        </ul>
                    </div>
                </nav>
                        ...
                        <section>
                            <div class="left quicklinks-main" role="article">
                                <div class="contentbox">
                                    <div class="heading">
                                        <header>
                                            <h1 id="cbx-l2">Ward Selected</h1>
                                        </header>
                                    </div>
                                    <div class="content">
                                        <ul class="quicklinks-sidebar">
                                            <li>
                                                <select class="form-control"  name="ward_number" id="view_ward_number" >
                                ...
                                <div class="contentbox">
                                    ...
                                    <div class="content">
                                        <ul class="quicklinks-sidebar">
                                            ...
                                            <li><a href="#"  style='font-size: 18px'; onclick =' categories(<?php echo $row['id'] ?>)' aria-describedby="cbx-l2"><?php echo $row['category_name'];?></a></li>
                                          <?php }?>
                                            <li>
                                ...
                                <div class="contentbox" id='contentbox' style='margin-top: 145px;'>
                                </div>
                            </div>
                        </section>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                <div id="content-wrap" class="left">
                                                                                                    <div class="slideshow-wrapper" style="height: unset;">
                                                                                                        <div
                                                                                                            id="blueimp-gallery-carousel"
                                                                                                            class="blueimp-gallery blueimp-gallery-carousel blueimp-gallery-controls blueimp-gallery-display blueimp-gallery-playing blueimp-gallery-left"
                                                                                                            style="display: block;"
                                                                                                        >
                                                                                                            <div class="slides" style="width: 1980px;">
                                                                                                                <div
                                                                                                                    class="slide"
                                                                                                                    data-index="0"
                                                                                                                    style="width: 660px; left: 0px; transition-duration: 400ms; transform: translate(0px) translateZ(0px);"
                                                                                                                >
                                                                                                                    <img
                                                                                                                        draggable="false"
                                                                                                                        alt="Municipal Corporation of Greater Mumbai"
                                                                                                                        src="<?php echo base_url('assets1/mumbai-head-office.jpg');?>"
                                                                                                                        class="slide-content"
                                                                                                                    />
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="slide"
                                                                                                                    data-index="1"
                                                                                                                    style="width: 660px; left: -660px; transition-duration: 0ms; transform: translate(660px) translateZ(0px);"
                                                                                                                >
                                                                                                                    <img
                                                                                                                        draggable="false"
                                                                                                                        alt="Municipal Corporation of Greater Mumbai"
                                                                                                                        src="<?php echo base_url('assets1/mumbai-mayor-m.png');?>"
                                                                                                                        class="slide-content"
                                                                                                                    />
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="slide"
                                                                                                                    data-index="2"
                                                                                                                    style="width: 660px; left: -1320px; transition-duration: 400ms; transform: translate(660px) translateZ(0px);"
                                                                                                                >
                                                                                                                    <img
                                                                                                                        draggable="false"
                                                                                                                        alt="Municipal Corporation of Greater Mumbai"
                                                                                                                        src="<?php echo base_url('assets1/municipal-commissioner_m.jpg');?>"
                                                                                                                        class="slide-content"
                                                                                                                    />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <div id="links">
                                                                                                            <a
                                                                                                                href="https://portal.mcgm.gov.in/MCGM/images/mumbai-head-office.jpg?rid=7a237d6a15247f299fbec3764ceafe43"
                                                                                                            ></a>
                                                                                                            <a
                                                                                                                href="https://portal.mcgm.gov.in/MCGM/images/mumbai-mayor-m.png?rid=7a237d6a15247f299fbec3764ceafe43"
                                                                                                            ></a>
                                                                                                            <a
                                                                                                                href="https://portal.mcgm.gov.in/MCGM/images/mumbai-head-office.jpg?rid=7a237d6a15247f299fbec3764ceafe43"
                                                                                                            ></a>
                                                                                                    ...
                                                                                                    <div id="ql-wrapper" style='margin-top: 40px;'>
                                                                                                        <div class="qlbox" id="citi-box">
                                                                                                            <div><img src="<?php echo base_url('assets1/project.png');?>" alt="नवीन प्रकल्पांची माहिती&lt;br/&gt;&lt;small&gt;&nbsp;&lt;/small&gt;" /></div>
                                                                                                            <div class="content">
                                                                                                                <h1>
                                                                                                                    Education<br />
                                                                                                                    <small>&nbsp;</small>
                                                                                                        ...
                                                                                                        <div class="qlbox" id="ward-box">
                                                                                                            <div><img src="<?php echo base_url('assets1/wards.png');?>" alt="वार्ड आणि विभाग&lt;br/&gt;&lt;small&gt;&nbsp;&lt;/small&gt;" /></div>
                                                                                                            <div class="content">
                                                                                                                <h1>
                                                                                                                    Chowky<br />
                                                                                                                    <small>&nbsp;</small>
                                                                                                        ...
                                                                                                        <div class="qlbox" id="rti-box">
                                                                                                            <div><img src="<?php echo base_url('assets1/tender.png');?>" alt="नवीन निविदा&lt;br/&gt;&lt;small&gt;&nbsp;&lt;/small&gt;" /></div>
                                                                                                            <div class="content">
                                                                                                                <h1>
                                                                                                                    Complaint Box<br />
                                                                                                                    <small>&nbsp;</small>
                                                                                                        ...
                                                                                                        <div class="qlbox" id="health-box">
                                                                                                            <div><img
                                                                                                                    src="<?php echo base_url('assets1/latest.png');?>"
                                                                                                                    alt="Online Building Plan Approval&lt;br/&gt;&lt;small&gt;(Single Window Clearance System)&lt;/small&gt;"
                                                                                                                />
                                                                                                            </div>
                                                                                                            <div class="content">
                                                                                                                <h1>
                                                                                                        ...
                                                                                                        <div class="qlbox" id="edu-box">
                                                                                                            <div><img src="<?php echo base_url('assets1/swm.png');?>" alt="घन कचरा व्यवस्थापन&lt;br/&gt;&lt;small&gt;&nbsp;&lt;/small&gt;" /></div>
                                                                                                            <div class="content">
                                                                                                                <h1>
                                                                                                                    Dustbin<br />
                                                                                                                    <small>&nbsp;</small>
                                                                                                        ...
                                                                                                        <div class="qlbox" id="env-box">
                                                                                                            <div><img src="<?php echo base_url('assets1/mcgmini.png');?>" alt="पर्यावरण&lt;br/&gt;&lt;small&gt;&nbsp;&lt;/small&gt;" /></div>
                                                                                                            <div class="content">
                                                                                                                <h1>
                                                                                                                    Dry & Wet Water<br />
                                                                                                                    <small>&nbsp;</small>
                                                                                                ...
                                                                                                <section>
                                                                                                  <div class="right quicklinks-main" role="article">
                                                                                                    <!-- <div class="contentbox" style='margin-top: -568px;'> -->
                                                                                                    <div class="contentbox">
                                                                                                      <div class="heading">
                                                                                                        <header>
                                                                                                      ...
                                                                                                      <div class="login-form">
                                                                                                        <form id="login-form" method="POST">
                                                                                                          ...
                                                                                                          <div class="checkbox">
                                                                                                            ...
                                                                                                            <label class="pull-right">
                                                                                                                    Not Registered yet? <a href="#" onclick='sign_up()' style='font-size: 10px;color: blue;'>Sign up</a>
                                                                                                            </label> 
                                                                                                          </div>
            ...
            <footer>
                <div class="footer text-center" role="contentinfo">
                    <p><a href="https://bwebtechnology.com/">B-WEB TECHNOLOGY</a><br>
                    Copyright © 2021 All rights reserved | Designed by B Web Technology</p>
                    <!-- <div class="footlinks">
                        <ul>
                        </ul>
                        <span class="w3c">
        ...
        <div id="contact_modal" class="modal" style="overflow: scroll;margin-left: unset;">
        ...
        <div id="sign_up_modal" class="modal" style="overflow: scroll;margin-left: unset;">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="close">&times;</span>
                </div>
                <div class="modal-body" style='height: 480px;'>
                    <div class="heading">
                        <header>
                          <h1 id="cbx-r1">Registeration Form</h1>
                        </header>
                    </div><br/>
                    <form method="post" id="register-form" enctype="multipart/form-data">
                        ...
                        <input type="number" name="user_contact" id='user_contact' placeholder="Enter...">

                        <label for="country">Age</label>
                        <input type="number" name="user_age" id='user_age' placeholder="Enter...">

                        <label for="country">Email address</label>
                        <input type="email" name="user_email" id='user_email' placeholder="Enter...">

                        <label for="subject">Password</label>
                        <input type="password" name="user_password" id='user_password' placeholder="Enter...">
                        <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" style='border-radius: 11px;height: 38px;width: 82px;margin-left: 5px;padding: 2px;font-size: 14px;'>Register</button><br/>
                        <div id="response"></div>
                    </form>
                </div>
            </div> 
...
<script>
    $('#view_ward_number').on('change',dosomething);
    function dosomething(){
        var ward_num = $('#view_ward_number').val();
        $.ajax({
            url: "<?php echo base_url(); ?>user_login/show_ward_categories_id/"+ward_num,
            success: function (result) {
                if(result == 'success'){
                    window.open('<?php echo base_url('user_login/show_particular_categories_data/') ?>'+0+'/'+ward_num, '_self');
                }else{
                    alert('no data found');
                }
            },
  ...
  function categories(id){
    $.ajax({
      success: function (result) {
        window.open('<?php echo base_url('user_login/show_particular_categories_data/') ?>'+id, '_self')
      }
    });
  }
  ...
  $('#login-form').submit(function(e){
    ...
    console.log(form);
    $.ajax({
      url: "<?php echo base_url();?>user_login/user_verify",
      type:"POST",
      data:form,
      processData:false,
      cache:false,
  ...
  $('#register-form').submit(function(e){
    ...
    console.log(form);
    $.ajax({
      url: "<?php echo base_url();?>user_login/user_registeration",
      type:"POST",
      data:form,
      cache:false,
      dataType: 'json',
