            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style='height: 480px;'>
                    ...
                    <form method="post" id="contact" enctype="multipart/form-data">
                        ...
                        <input type="email" name="user_age" id='user_age' placeholder="Enter...">
...
<script>
  ...
  Array.prototype.forEach.call(allData, function(data){
    ...
    function dosomething(){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>add_service_station/show_ward_categories_id/"+ward_num,
            success: function (result) {
                console.log(result);
                window.open('<?php echo base_url('add_service_station/show_particular_categories_data/') ?>'+0+'/'+ward_num, '_self');
                // var cat_id = result;
                // $.ajax({
                //     url: '<?php echo base_url('add_service_station/show_particular_categories_data/') ?>'+0+'/'+ward_num,
                //     type: 'POST',
                //     data: {id:cat_id},
                //     success:function(result){
                //         console.log(result);
                //     }
                //         window.open('<?php echo base_url('add_service_station/show_particular_categories_data/') ?>'+cat_id+'/'+ward_num, '_self');
                // });
            },
        });
    }
  ...
  function categories(id){
    $.ajax({
      success: function (result) {
        window.open('<?php echo base_url('add_service_station/show_particular_categories_data/') ?>'+id, '_self')
      }
    });
  }
